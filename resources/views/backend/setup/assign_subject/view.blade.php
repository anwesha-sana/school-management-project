					  ...
					  <table id="example1" class="table table-bordered table-striped">
						...
						<tbody>
							...
							<tr>
								...
								<td>
                                    <a href="{{ route('assign.subject.edit',$assign->class_id )}}" class="btn btn-rounded btn-info mb-5"><i class="fa fa-edit"></i></a>
                                    <a href="{{ route('assign.subject.details',$assign->class_id )}}" class="btn btn-rounded btn-success mb-5"><i class="fa fa-eye"></i></a>
                                </td>

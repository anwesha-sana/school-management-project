		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
			  <h4 class="box-title">Edit Assign Subjects</h4>
                           ...
                           <div class="row">
                              ...
                              <div class="col-md-2">
                                 <div class="form-group">
                                    ...
                                    <div class="controls">
                                       <input type="text" name="full_mark[]" value = "{{ $item->full_mark }}"  class="form-control" > 
                                    </div>		 
                                 </div>
                              </div><!-- End col-md-2 -->
							  <div class="col-md-2">
								<div class="form-group">
								   ...
								   <div class="controls">
									  <input type="text" name="pass_mark[]" value = "{{ $item->pass_mark }}" class="form-control" > 
								   </div>		 
								</div>
							 </div><!-- End col-md-2 -->
							 <div class="col-md-2">
								<div class="form-group">
								   ...
								   <div class="controls">
									  <input type="text" name="subjective_mark[]" value = "{{ $item->subjective_mark }}" class="form-control" > 
								   </div>		 
								</div>
							 </div><!-- End col-md-2 -->
